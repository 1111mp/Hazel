...
#define IMGUI_UNLIMITED_FRAME_RATE
  ...
  void VulkanContext::InitForVulkan()
  {
    // Create DescriptorPool for m_ImGuiDescriptorPool
    {
      ...
      HZ_CORE_ASSERT(vkCreateDescriptorPool(m_Device, &pool_info, nullptr, &m_ImGuiDescriptorPool) == VK_SUCCESS, "Create DescriptorPool for m_ImGuiDescriptorPool failed!");
    }
  ...
  void VulkanContext::DrawFrame()
  {
    ...
    {
      HZ_CORE_ASSERT(false, "failed to acquire swap chain image!");
    }
    ...
    {
      HZ_CORE_ASSERT(false, "failed to present swap chain image!");
    }
  ...
  VkCommandBuffer VulkanContext::BeginSingleTimeCommands(const VkCommandPool &cmdPool)
  {
  ...
  void VulkanContext::EndSingleTimeCommands(const VkCommandBuffer &commandBuffer, const VkCommandPool &cmdPool)
  {
  ...
  void VulkanContext::CreateInstance()
  {
    ...
    HZ_CORE_ASSERT(vkCreateInstance(&createInfo, nullptr, &m_Instance) == VK_SUCCESS, "failed to create instance!");
  }
  ...
  void VulkanContext::SetupDebugMessenger()
  {
    ...
    HZ_CORE_ASSERT(CreateDebugUtilsMessengerEXT(m_Instance, &createInfo, nullptr, &m_DebugMessenger) == VK_SUCCESS, "failed to set up debug messenger!");
  }

  void VulkanContext::CreateSurface()
  {
    HZ_CORE_ASSERT(glfwCreateWindowSurface(m_Instance, m_WindowHandle, nullptr, &m_Surface) == VK_SUCCESS, "failed to create window surface!");
  }
  ...
  void VulkanContext::CreateLogicalDevice()
  {
    ...
    if (m_EnableValidationLayers)
    {
      createInfo.enabledLayerCount = static_cast<uint32_t>(m_DeviceExtensions.size());
      createInfo.ppEnabledLayerNames = m_DeviceExtensions.data();
    }
    else
    {
      createInfo.enabledLayerCount = 0;
    ...
    HZ_CORE_ASSERT(vkCreateDevice(m_PhysicalDevice, &createInfo, nullptr, &m_Device) == VK_SUCCESS, "failed to create logical device!");
  ...
  void VulkanContext::CreateDescriptorSetLayout()
  {
    ...
    HZ_CORE_ASSERT(vkCreateDescriptorSetLayout(m_Device, &layoutInfo, nullptr, &m_DescriptorSetLayout) == VK_SUCCESS, "failed to create descriptor set layout!");
  }
  ...
  void VulkanContext::CreateGraphicsPipeline()
  {
    ...
    HZ_CORE_ASSERT(vkCreateGraphicsPipelines(m_Device, VK_NULL_HANDLE, 1, &pipelineInfo, nullptr, &m_GraphicsPipeline) == VK_SUCCESS, "failed to create graphics pipeline!");
  ...
  void VulkanContext::CreateCommandPool(VkCommandPool *cmdPool)
  {
    ...
    HZ_CORE_ASSERT(vkCreateCommandPool(m_Device, &poolInfo, nullptr, cmdPool) == VK_SUCCESS, "failed to create command pool!");
  }
  ...
  void VulkanContext::CreateTextureImage()
  {
    ...
    stbi_uc *pixels = stbi_load((AssetsDir + "/textures/ChernoLogo.png").c_str(), &texWidth, &texHeight, &texChannels, STBI_rgb_alpha);
    VkDeviceSize imageSize = texWidth * texHeight * 4;

    HZ_CORE_ASSERT(pixels, "failed to load texture image!");
  ...
  void VulkanContext::CreateTextureSampler()
  {
    ...
    HZ_CORE_ASSERT(vkCreateSampler(m_Device, &samplerInfo, nullptr, &m_TextureSampler) == VK_SUCCESS, "failed to create texture sampler!");
  }
  ...
  void VulkanContext::CreateDescriptorSets()
  {
    ...
    HZ_CORE_ASSERT(vkAllocateDescriptorSets(m_Device, &allocInfo, m_DescriptorSets.data()) == VK_SUCCESS, "failed to allocate descriptor sets!");
  ...
  void VulkanContext::CreateSyncObjects()
  {
    ...
    for (size_t i = 0; i < MAX_FRAMES_IN_FLIGHT; i++)
    {
          ...
          vkCreateFence(m_Device, &fenceInfo, nullptr, &m_InFlightFences[i]) != VK_SUCCESS)
      {
        ...
        HZ_CORE_ASSERT(false, "failed to create semaphores!");
      }
    }
  }
  ...
  VkResult VulkanContext::CreateDebugUtilsMessengerEXT(const VkInstance &instance, const VkDebugUtilsMessengerCreateInfoEXT *pCreateInfo, const VkAllocationCallbacks *pAllocator, VkDebugUtilsMessengerEXT *pDebugMessenger)
  {
  ...
  void VulkanContext::CreateBuffer(VkDeviceSize size, VkBufferUsageFlags usage, VkMemoryPropertyFlags properties, VkBuffer &buffer, VkDeviceMemory &bufferMemory)
  {
    ...
    HZ_CORE_ASSERT(vkCreateBuffer(m_Device, &bufferInfo, nullptr, &buffer) == VK_SUCCESS, "failed to create buffer!");
    ...
    HZ_CORE_ASSERT(vkAllocateMemory(m_Device, &allocInfo, nullptr, &bufferMemory) == VK_SUCCESS, "failed to allocate buffer memory!");
  ...
  VkImageView VulkanContext::CreateImageView(VkImage image, VkFormat format, VkImageAspectFlags aspectFlags)
  {
    ...
    HZ_CORE_ASSERT(vkCreateImageView(m_Device, &viewInfo, nullptr, &imageView) == VK_SUCCESS, "failed to create texture image view!");
